...
function deepClone<T>(original: T): T extends Set<unknown> | Map<unknown, unknown> | Collection<unknown> ? never : T {
    // Simple types
    if (typeof original !== "object" || original === null) {
        return original as T extends Set<unknown> | Map<unknown, unknown> | Collection<unknown> ? never : T;
    }

    // Arrays
    if (original instanceof Array) {
        return original.map(deepClone) as unknown as T extends
            | Set<unknown>
            | Map<unknown, unknown>
            | Collection<unknown>
            ? never
    ...
    if (original instanceof Date) {
        return new Date(original) as unknown as T extends Set<unknown> | Map<unknown, unknown> | Collection<unknown>
            ? never
            : T;
    }
    ...
    return clone as unknown as T extends Set<unknown> | Map<unknown, unknown> | Collection<unknown> ? never : T;
}
...
export function getType(variable: unknown): string {
    ...
    if (!(variable as object).constructor) {
        return "Object";
    } // Object with the null prototype.
    if ((variable as object).constructor.name === "Object") {
        return "Object";
    } // simple objects
...
function objectsEqual(a: object | null, b: object | null): boolean {
    ...
    return Object.entries(a).every(([k, v0]) => {
        ...
        if (t0 === "Object") {
            return objectsEqual(v0, v1 as object | null);
        }
        return v0 === v1;
    });
}
...
function _arrayEquals(arr: unknown[], other: unknown): boolean {
    if (!(other instanceof Array) || other.length !== arr.length) {
        return false;
    }
    return arr.every((v0, i) => {
        ...
        if (t0 === "Object") {
            return objectsEqual(v0 as object, v1);
        }
        return v0 === v1;
    });
}
...
function diffObject(original: object, other: object, { inner = false, deletionKeys = false } = {}) {
    ...
    return Object.keys(other).reduce((obj, key) => {
        ...
        if (isDeletionKey && deletionKeys) {
            ...
            if (otherKey in original) {
                (obj as Record<string, unknown>)[key] = (other as Record<string, unknown>)[key];
            }
            return obj;
        }
        ...
        if (isDifferent) {
            (obj as Record<string, unknown>)[key] = difference;
        }
        return obj;
    }, {});
}
